...
public class CachedLetter implements Serializable {
    ...
    @Builder.Default
    private List<ContextFontResponse> contextFonts = new ArrayList<>();
    ...
    public void setContextFonts(List<ContextFontResponse> contextFonts) {
        this.contextFonts = contextFonts;
    }
